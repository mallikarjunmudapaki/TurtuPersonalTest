...
export default function ResetPassword() {
  ...
  const handleSubmit = (e) => {
    ...
    // Send both password and confirmPassword to the backend
    // axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/reset_password/${token}`, { 
    //     password, 
    //     confirm_password: confirmPassword // Send confirm password as well
    // })
    axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/reset_password/${token}`, { 
      password, 
...
//     axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/reset-password/${token}`, { password }) // <-- Corrected interpolation with backticks
//       .then(response => {
//         setMessage('Password has been successfully reset. Redirecting to login...');
//         setError('');
//         setTimeout(() => navigate('/login'), 3000); 
...
//     axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/reset_password/${token}`, { password })
//       .then(response => {
//         setMessage('Password has been successfully reset. Redirecting to login...');
//         console.log(token);
//         setError('');
